...
public class ShopApp {
    ...
    public ShopApp( NotificationService primaryNotification, NotificationService emailNotification, PaymentProcessor defaultPayment, PaymentProcessor stripePayment, List<NotificationService> allNotifications, Map<String, PaymentProcessor> paymentMap) {
